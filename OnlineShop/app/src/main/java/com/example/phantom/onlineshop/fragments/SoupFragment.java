...
public class SoupFragment extends Fragment {
    private final static String CATEGORY_ID = "6";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_soup, container, false);
        ...
        RecyclerView recyclerView = (RecyclerView) layout.findViewById(R.id.soup_recycler);
