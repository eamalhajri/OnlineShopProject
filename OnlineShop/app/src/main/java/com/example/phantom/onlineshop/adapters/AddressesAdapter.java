...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.AddressesViewHolder> {
    ...
    public static class AddressesViewHolder extends RecyclerView.ViewHolder {
        ...
        public AddressesViewHolder(View v) {
            super(v);
            cardView = (CardView) v;
    ...
    public AddressesAdapter(String[] names, int[] images, Context context) {
        this.names = names;
        this.images = images;
    ...
    public AddressesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AddressesViewHolder(cv);
    }

    @Override
    public void onBindViewHolder(AddressesViewHolder holder, final int position) {
