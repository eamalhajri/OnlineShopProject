...
public class DessertFragment extends Fragment {
    private final static String CATEGORY_ID = "10";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_dessert, container, false);
        ...
        RecyclerView recyclerView = (RecyclerView) layout.findViewById(R.id.dessert_recycler);
